...
export const SLASH_COMMANDS: SlashCommandDef[] = [
  ...
  { name: 'signin', args: '[codex|anthropic|xai|kimi|antigravity]', description: 'Sign in to Codex (ChatGPT), Anthropic (Claude.ai), Grok (xAI), Kimi, or Antigravity (Google)' },
  { name: 'signout', args: '[codex|anthropic|xai|kimi|antigravity]', description: 'Sign out of Codex, Anthropic, Grok, Kimi, or Antigravity' },
